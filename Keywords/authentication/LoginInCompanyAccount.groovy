...
public class LoginInCompanyAccount {
	static def login() {
		WebUI.openBrowser("")
		...
		WebUI.setText(findTestObject('Object Repository/LoginPage/txt_Email'), "Company1@gmail.com")
		WebUI.setText(findTestObject('Object Repository/LoginPage/txt_Password'), "Company1@gmail.com")
