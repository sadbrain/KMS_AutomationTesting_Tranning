...
WebUI.setText(findTestObject('DetailPage/txt_Count'), '49')

'Verify the quantity input is updated correctly'
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('DetailPage/txt_Count'), 'value'), '49', false)

'get name product'
productName = WebUI.getText(findTestObject('DetailPage/h3_ProductName')).toLowerCase()
'get unit price when add 49 product'
unitPrice50 = WebUI.getText(findTestObject('DetailPage/div_Price50'))
...
'verify unit price when add 49 product'
WebUI.verifyMatch(unitPrice50.replaceAll("[^\\d.]", ""), unitPriceCart, false)
