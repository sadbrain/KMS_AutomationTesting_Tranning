...
'Step 6 Update the quantity in the input field'
WebUI.setText(findTestObject('DetailPage/txt_Count'), '2')

'Verify the quantity input is updated correctly'
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('DetailPage/txt_Count'), 'value'), '2', false)
'get name product'
...
'get quantity by h6Text'
String h6Text = WebUI.getText(quantityElement)
String quantity = h6Text.split('x')[1].trim()

'verify quantity is cumulative'
WebUI.verifyMatch(quantity, '3', false)
