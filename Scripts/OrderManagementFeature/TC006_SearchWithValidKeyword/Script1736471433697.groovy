...
// Search for orders with the keyword 'Pending'  
WebUI.setText(findTestObject('Object Repository/OrderListPage/txt_Search'), 'Pending')  
...
for (int i = 0; i < rows.size(); i++) {  
    ...
    // Verify if the status matches 'Pending'  
